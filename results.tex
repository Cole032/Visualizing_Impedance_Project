...
\end{figure}
To verify the reproducibility of our data we can compare mic 1 of Fig. \ref{fig:Mic_data_orig_config} to mic 2 of Fig. \ref{fig:Mic_data_swapped}. These two paths should look similar since they are detecting the pressure at the same location and the same acoustic environment.
